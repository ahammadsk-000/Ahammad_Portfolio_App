...
export const PERSONAL = {
  ...
  heroSubtitle:
    "Sr. Python Backend Developer with 7.4 years of IT experience (6.4 relevant), specializing in Django, REST APIs, and AI-powered backend systems — LLM integration, RAG, LangChain, and multi-agent systems.",
  summary:
    "Sr. Python Backend Developer with 7.4 years of IT experience (6.4 years relevant), specializing in Django, REST APIs, and AI-powered backend systems. Hands-on expertise in LLM integration, Retrieval-Augmented Generation (RAG), LangChain, Agentic AI, and multi-agent systems using Hugging Face, Ollama, and ChromaDB. Proficient in AWS (EC2, S3, Lambda, RDS), Docker, and Kubernetes. Experienced in delivering production-grade solutions in Agile environments at scale.",
...
export const SKILL_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      { name: "LLM Integration", level: 91 },
      { name: "RAG", level: 92 },
      { name: "LangChain", level: 91 },
      { name: "Agentic AI", level: 88 },
      { name: "Multi-Agentic Systems", level: 87 },
      { name: "HuggingFace", level: 85 },
      { name: "Ollama", level: 86 },
      { name: "ChromaDB", level: 85 },
      { name: "Prompt Engineering", level: 90 },
      { name: "Embeddings & Vector DB", level: 86 },
      { name: "Gradio / QLoRA / Modal", level: 80 },
    ],
  },
  {
    title: "Cloud — AWS",
    ...
    skills: [
      ...
      { name: "RDS", level: 84 },
      { name: "IAM", level: 85 },
      { name: "EBS / ASG / VPC", level: 82 },
      { name: "CloudFront / Route 53", level: 80 },
      { name: "Boto3", level: 84 },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Jules (CI/CD)", level: 82 },
      { name: "Verum / Prime / Dev Shell", level: 84 },
    ],
  },
];
...
export const EXPERIENCE: ExperienceItem[] = [
  {
    ...
    stack: ["Python", "Django", "REST API", "SQLite", "ServiceNow", "Agile"],
    period: "Apr 2024 — May 2026",
    location: "Hyderabad, India",
    icon: Workflow,
    highlights: [
      "Built a Django-based web application to automate the decommissioning of enterprise assets (servers, databases, and SAN/NAS storage) across multiple business units",
      "Designed RESTful APIs and CRUD operations using Django MVT architecture, enabling seamless integration with downstream systems",
      "Integrated ServiceNow (SNOW) to automate work order generation and manage the complete asset retirement lifecycle from creation to closure",
      "Processed enterprise asset data from Verum and collaborated with cross-functional Agile teams to deliver enhancements and maintain application stability",
    ],
  },
  {
    company: "Cognizant Technology Solutions",
    ...
    stack: ["Python", "Flask", "Tableau", "Control-M", "DR/SR", "GitHub", "Automation"],
    period: "Aug 2022 — Mar 2024",
    location: "Hyderabad, India",
    icon: ShieldCheck,
    highlights: [
      "Built Flask-based applications for Hortonworks and VAPVSI server management platforms handling data centre operations across Ashburn and Piscataway",
      "Executed DR (Disaster Recovery) and SR (System Resiliency) activities, managing primary-to-secondary server failover and switchback processes",
      "Migrated Tableau dashboards and Control-M jobs, ensuring uninterrupted data pipeline and job scheduling continuity post-migration",
      "Executed full codebase migration from Bitbucket to GitHub, maintaining version control continuity across active development workflows",
    ],
  },
  {
    company: "Accenture",
    ...
    stack: ["Python", "Django", "MySQL", "SQLite3", "MVT Architecture"],
    period: "Jan 2019 — Aug 2022",
    location: "Hyderabad, India",
    icon: Cpu,
    highlights: [
      "Built internal survey applications for Accenture Managers and Senior Managing Directors with policy feedback sections and automated certificate generation upon completion",
      "Developed server-side business logic using Django Views, SQLite3 for lightweight operations, and MySQL for persistent data management with Django Templates for frontend rendering",
...
export const PROJECTS: Project[] = [
  {
    ...
    tech: ["Python", "LangChain", "LLM", "Multi-Agent", "FastAPI", "GitHub API"],
    icon: Code2,
  ...
  },
  {
    ...
    tech: ["Python", "LangChain", "RAG", "ChromaDB", "HuggingFace"],
    icon: Database,
  ...
  },
  {
    ...
    tech: ["Python", "LLM", "LangChain", "RAG", "Gradio"],
    icon: BrainCircuit,
  ...
  },
  {
    ...
    tech: ["Python", "HuggingFace", "Generative AI", "Diffusion"],
    icon: Sparkles,
  ...
  },
  {
    ...
    tech: ["Python", "OpenCV", "DeepFace", "PyTorch"],
    icon: ShieldCheck,
